    ...
    sock[token].ev.process(
        ...
        if (qr) {
          ...
          QRCode.toDataURL(qr, function (err, url) {
            ...
            qrcode[token] = url
            try {
              io.emit('qrcode', {token, data: url, message: "Qrcode updated, please scan with your Whatsapp Device"})
            } catch (error) {
              lib.log.error(error)
            }
          })
        ...
        manageIncomingMessage({token, upsert: events['messages.update'], io})
			}
        ...
        manageIncomingMessage({token, upsert: events['message-receipt.update'], io})
			}
        ...
        manageIncomingMessage({token, upsert: events['messages.reaction'], io})
			}
        ...
        manageIncomingMessage({token, upsert: events['presence.update'], io})
			}
        ...
        manageIncomingMessage({token, upsert: events['chats.update'], io})
			}
        ...
        manageIncomingMessage({token, upsert: events['chats.delete'], io})
			}
		}
	)
...
async function sendMedia(token, number, type, url, fileName, caption) {
    ...
    try {
        if ( type == 'image' ) {
            ...
            var data = { document: url ? {url} : fs.readFileSync('src/public/temp/'+fileName), mimetype: 'application/pdf', fileName: fileName? fileName : 'Attachment.pdf', caption: caption ? caption : null}
        } else if ( type == 'xls' ) {
            var data = { document: url ? {url} : fs.readFileSync('src/public/temp/'+fileName), mimetype: 'application/excel', fileName: fileName? fileName : 'Attachment.xls', caption: caption ? caption : null}
        } else if ( type == 'xlsx' ) {
            var data = { document: url ? {url} : fs.readFileSync('src/public/temp/'+fileName), mimetype: 'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet', fileName: fileName? fileName : 'Attachment.xlsx', caption: caption ? caption : null}
        } else if ( type == 'doc' ) {
            var data = { document: url ? {url} : fs.readFileSync('src/public/temp/'+fileName), mimetype: 'application/msword', fileName: fileName? fileName : 'Attachment.doc', caption: caption ? caption : null}
        } else if ( type == 'docx' ) {
            var data = { document: url ? {url} : fs.readFileSync('src/public/temp/'+fileName), mimetype: 'application/vnd.openxmlformats-officedocument.wordprocessingml.document', fileName: fileName? fileName : 'Attachment.docx', caption: caption ? caption : null}
        } else if ( type == 'zip' ) {
            var data = { document: url ? {url} : fs.readFileSync('src/public/temp/'+fileName), mimetype: 'application/zip', fileName: fileName? fileName : 'Attachment.zip', caption: caption ? caption : null}
        } else if ( type == 'mp3' ) {
            var data = { document: url ? {url} : fs.readFileSync('src/public/temp/'+fileName), mimetype: 'application/mp3', fileName: fileName? fileName : 'Attachment.mp3', caption: caption ? caption : null}
        } else {
